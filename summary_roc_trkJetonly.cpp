...
const char* output_file_name = "TrigSummary2trk_7.5_1.5_5GeV_noFakes_30mm_1";
//! clears the txt file
...
void roc(const char *pileup, const char *gapsize)
{
	...
	Float_t Ymin_range = 1e-2, Ymax_range = 50.0;
	...
	////////////////////////////////////////////////
	const char *file_path = "./fastjet_output/TriggerStudies_1";
	...
	//sprintf(signal_file_name, "%s/NewjetoutPU%shh4b_%smm_optsig5_1tracks7.5_5GeV_noFakes.root",file_path,pileup,gapsize);//7.5
	sprintf(signal_file_name, "%s/TrkJPU%sggFhh4b7.5mm_%smm_2trk2.5_5GeV_noFakes.root",file_path,pileup,gapsize);//7.5
	...
	//sprintf(MinBias_file_name, "%s/NewjetoutPU%sMB_%smm_optsig5_1tracks7.5_5GeV_noFakes.root",file_path,pileup,gapsize);//7.5
	sprintf(MinBias_file_name, "%s/TrkJPU%sMB7.5mm_%smm_2trk2.5_5GeV_noFakes.root",file_path,pileup,gapsize);//7.5
...
//////////////////////////////////////////////////////////////
	...
	//sprintf(signal_file_name_1, "%s/NewjetoutPU%shh4b_%smm_optsig5_1tracks3.75_5GeV_noFakes.root",file_path,pileup,gapsize);
	sprintf(signal_file_name_1, "%s/TrkJPU%sggFhh4b1.5mm_%smm_2trk2.5_5GeV_noFakes.root",file_path,pileup,gapsize);//1.5
	...
	//sprintf(MinBias_file_name_1, "%s/NewjetoutPU%sMB_%smm_optsig5_1tracks3.75_5GeV_noFakes.root",file_path,pileup,gapsize);
	sprintf(MinBias_file_name_1, "%s/TrkJPU%sMB1.5mm_%smm_2trk2.5_5GeV_noFakes.root",file_path,pileup,gapsize);//1.5
	...
	//c1->cd(4);
	g1_->SetFillStyle(0);
	g1_->SetTitle("2^{nd} leading pt track-jet, sum_pt, bin_size: +-1.5mm ");
	//g1_->Draw("ACPe1");
	g1_->Draw("APe1");
	...
	//c1->cd(4);
	g2_->SetFillStyle(0);
	g2_->SetTitle("3^{rd} leading pt track-jet, sum_pt, bin_size: +-1.5mm ");
	//g2_->Draw("CPe1");
	g2_->Draw("Pe1");
	...
	//c1->cd(4);
	g3_->SetFillStyle(0);
	g3_->SetTitle("4^{th} leading pt track-jet, sum_pt, bin_size: +-1.5mm ");
	//g3_->Draw("CPe1");
	g3_->Draw("Pe1");
	...
	//c1->cd(4);
	g4_->SetFillStyle(0);
	g4_->SetTitle("5^{th} leading pt track-jet, sum_pt, bin_size: +-1.5mm ");
	//g4_->Draw("CPe1");
	g4_->Draw("Pe1");
	...
	//c1->cd(4);
	ga1_->SetFillStyle(0);
	ga1_->SetTitle("2^{nd} leading pt track-jet, max_pt, bin_size: +-1.5mm ");
	//g1->Draw("ACPe1");
	ga1_->Draw("APe1");
	...
	//c1->cd(4);
	ga2_->SetFillStyle(0);
	ga2_->SetTitle("3^{rd} leading pt track-jet, max_pt, bin_size: +-1.5mm ");
	//ga2_->Draw("CPe1");
	ga2_->Draw("Pe1");
	...
	//c1->cd(4);
	ga3_->SetFillStyle(0);
	ga3_->SetTitle("4^{th} leading pt track-jet, max_pt, bin_size: +-1.5mm ");
	//ga3_->Draw("CPe1");
	ga3_->Draw("Pe1");
	...
	//c1->cd(4);
	ga4_->SetFillStyle(0);
	ga4_->SetTitle("5^{th} leading pt track-jet, max_pt, bin_size: +-1.5mm ");
	//ga4_->Draw("CPe1");
	ga4_->Draw("Pe1");
...
/////////////////////////////////////////////////////////////////////////////////////////////
	...
	sprintf(MinBias_file_calo, "%s/EMU5GeV_PU%sMB_q1.2GeVeta2.5_%smmR0.4_1.root",file_path,pileup,gapsize);
...
/////////////////////////////////////////////////////////////
	...
	ga2d_1->SetName("2nd_maxpt");
	ga2d_1->SetMarkerStyle(kFullStar);
	ga2d_1->SetMarkerSize(1.0);
	ga2d_1->SetFillStyle(0);
	ga2d_1->SetTitle("track-jet, max_pt, 1.5mm");
	//ga2d_1->SetTitle("2^{nd} leading pt track-jet, max_pt, bin_size: 1.5mm");
	ga2d_1->Draw("PCOLZ");
	TGraph2D *ga2d_2 = new TGraph2D(n,ea_3,ra_3,pt_threshold);
	ga2d_2->SetName("3rd_maxpt");
	ga2d_2->SetMarkerStyle(kFullStar);
	ga2d_2->SetMarkerSize(1.0);
	ga2d_2->SetFillStyle(0);
	ga2d_2->SetTitle("track-jet, max_pt, 1.5mm");
	//ga2d_2->SetTitle("3^{rd} leading pt track-jet, max_pt, bin_size: 1.5mm");
	ga2d_2->Draw("PCOLZ");
	TGraph2D *ga2d_3 = new TGraph2D(n,ea_4,ra_4,pt_threshold);
	ga2d_3->SetName("4th_maxpt");
	ga2d_3->SetMarkerStyle(kFullStar);
	ga2d_3->SetMarkerSize(1.0);
	ga2d_3->SetFillStyle(0);
	ga2d_3->SetTitle("track-jet, max_pt, 1.5mm");
	//ga2d_3->SetTitle("4^{th} leading pt track-jet, max_pt, bin_size: 1.5mm");
	ga2d_3->Draw("PCOLZ");
	TGraph2D *ga2d_4 = new TGraph2D(n,ea_5,ra_5,pt_threshold);
	ga2d_4->SetName("5th_maxpt");
	ga2d_4->SetMarkerStyle(kFullStar);
	ga2d_4->SetMarkerSize(1.0);
	ga2d_4->SetFillStyle(0);
	ga2d_4->SetTitle("track-jet, max_pt, 1.5mm");
	//ga2d_4->SetTitle("5^{th} leading pt track-jet, max_pt, bin_size: 1.5mm");
	ga2d_4->Draw("PCOLZ");
	...
	g2d_1->SetTitle("track-jet, sum_pt, +-1.5mm");
	//g2d_1->SetTitle("2^{nd} leading pt track-jet, sum_pt, bin_size: +-1.5mm");
	g2d_1->Draw("PCOLZ");
	...
	g2d_2->SetTitle("track-jet, sum_pt, +-1.5mm");
	//g2d_2->SetTitle("3^{rd} leading pt track-jet, sum_pt, bin_size: +-1.5mm");
	g2d_2->Draw("PCOLZ");
	...
	g2d_3->SetTitle("track-jet, sum_pt, +-1.5mm");
	//g2d_3->SetTitle("4^{th} leading pt track-jet, sum_pt, bin_size: +-1.5mm");
	g2d_3->Draw("PCOLZ");
	...
	g2d_4->SetTitle("track-jet, sum_pt, +-1.5mm");
	//g2d_4->SetTitle("5^{th} leading pt track-jet, sum_pt, bin_size: +-1.5mm");
	g2d_4->Draw("PCOLZ");
