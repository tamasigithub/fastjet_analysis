...
{
	g1_ = new TGraphErrors(n,r2_,e2_,r_err2_,e_err2_);
	g1_->GetYaxis()->SetTitle("trigger efficiency");
	auto axis = g1_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	g1_->GetXaxis()->SetTitleOffset(1.2);
	g1_->GetXaxis()->SetTitle("trigger rate [MHz]");
	g1_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	g2_ = new TGraphErrors(n,r3_,e3_,r_err3_,e_err3_);
	g2_->GetYaxis()->SetTitle("trigger efficiency");
	axis = g2_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	g2_->GetXaxis()->SetTitleOffset(1.2);
	g2_->GetXaxis()->SetTitle("trigger rate [MHz]");
	g2_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	g3_ = new TGraphErrors(n,r4_,e4_,r_err4_,e_err4_);
	g3_->GetYaxis()->SetTitle("trigger efficiency");
	axis = g3_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	g3_->GetXaxis()->SetTitleOffset(1.2);
	g3_->GetXaxis()->SetTitle("trigger rate [MHz]");
	g3_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	g4_ = new TGraphErrors(n,r5_,e5_,r_err5_,e_err5_);
	g4_->GetYaxis()->SetTitle("trigger efficiency");
	axis = g4_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	g4_->GetXaxis()->SetTitleOffset(1.2);
	g4_->GetXaxis()->SetTitle("trigger rate [MHz]");
	g4_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	ga1_ = new TGraphErrors(n,ra_2,ea_2,r_erra_2,e_erra_2);
	ga1_->GetYaxis()->SetTitle("trigger efficiency");
	axis = ga1_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	ga1_->GetXaxis()->SetTitleOffset(1.2);
	ga1_->GetXaxis()->SetTitle("trigger rate [MHz]");
	ga1_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	ga2_ = new TGraphErrors(n,ra_3,ea_3,r_erra_3,e_erra_3);
	ga2_->GetYaxis()->SetTitle("trigger efficiency");
	axis = ga2_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	ga2_->GetXaxis()->SetTitleOffset(1.2);
	ga2_->GetXaxis()->SetTitle("trigger rate [MHz]");
	ga2_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	ga3_ = new TGraphErrors(n,ra_4,ea_4,r_erra_4,e_erra_4);
	ga3_->GetYaxis()->SetTitle("trigger efficiency");
	axis = ga3_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	ga3_->GetXaxis()->SetTitleOffset(1.2);
	ga3_->GetXaxis()->SetTitle("trigger rate [MHz]");
	ga3_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	ga4_ = new TGraphErrors(n,ra_5,ea_5,r_erra_5,e_erra_5);
	ga4_->GetYaxis()->SetTitle("trigger efficiency");
	axis = ga4_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	ga4_->GetXaxis()->SetTitleOffset(1.2);
	ga4_->GetXaxis()->SetTitle("trigger rate [MHz]");
	ga4_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	gb1_ = new TGraphErrors(n,rb_2,eb_2,r_errb_2,e_errb_2);
	gb1_->GetYaxis()->SetTitle("trigger efficiency");
	axis = gb1_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	gb1_->GetXaxis()->SetTitleOffset(1.2);
	gb1_->GetXaxis()->SetTitle("trigger rate [MHz]");
	gb1_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	gb2_ = new TGraphErrors(n,rb_3,eb_3,r_errb_3,e_errb_3);
	gb2_->GetYaxis()->SetTitle("trigger efficiency");
	axis = gb2_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	gb2_->GetXaxis()->SetTitleOffset(1.2);
	gb2_->GetXaxis()->SetTitle("trigger rate [MHz]");
	gb2_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	gb3_ = new TGraphErrors(n,rb_4,eb_4,r_errb_4,e_errb_4);
	gb3_->GetYaxis()->SetTitle("trigger efficiency");
	axis = gb3_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	gb3_->GetXaxis()->SetTitleOffset(1.2);
	gb3_->GetXaxis()->SetTitle("trigger rate [MHz]");
	gb3_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	gb4_ = new TGraphErrors(n,rb_5,eb_5,r_errb_5,e_errb_5);
	gb4_->GetYaxis()->SetTitle("trigger efficiency");
	axis = gb4_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	gb4_->GetXaxis()->SetTitleOffset(1.2);
	gb4_->GetXaxis()->SetTitle("trigger rate [MHz]");
	gb4_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
