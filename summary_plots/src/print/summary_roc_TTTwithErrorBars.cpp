...
/////////////////////////////////////////////////////////////////////
	...
	//! page38
	//! page16
	ExRb_2->SetTitle("sum-pt,+-1.5mm binning ");
	ExRb_2->GetXaxis()->SetTitle("p_{T} [GeV/c]");
	ExRb_2->GetYaxis()->SetTitle("trigger rate [MHz]");
	ExRb_2->GetXaxis()->CenterTitle();
	ExRb_2->GetYaxis()->CenterTitle();	
	ExRb_2->GetYaxis()->SetRangeUser(Ymin_range, Ymax_range);
	ExRb_2->GetXaxis()->SetRangeUser(2.0, 0.9e3);
	////ExRb_2->GetXaxis()->SetRangeUser(0, 0.07e3);
	ExRb_2->GetXaxis()->SetTitleSize(0.04);
	ExRb_2->GetYaxis()->SetTitleSize(0.04);
	ExRb_2->GetYaxis()->SetTitleOffset(1.2);
	ExRb_2->Draw("hist ");
	ExRb_2->GetXaxis()->SetRangeUser(2.0, 0.9e3);
	ExRb_3->Draw("hist same");
	ExRb_4->Draw("hist same");
	ExRb_5->Draw("hist same");
	ExR2_->Draw("hist same");
	ExR3_->Draw("hist same");
	ExR4_->Draw("hist same");
	ExR5_->Draw("hist same");
	Rbcalo2->Draw("hist same");
	Rbcalo3->Draw("hist same");
	Rbcalo4->Draw("hist same");
	Rbcalo5->Draw("hist same");
	...
	//f_out->Close();
	std::cout<<"efficiency  rate  pT  ex  ey  ez  for the 4th leading jet "<<std::endl;	
	std::cout<<"Extended geometry 1.5mm max-bin:"<<std::endl;
	Exg2d_3->Print();

	std::cout<<"Extended geometry 7.5mm max-bin:"<<std::endl;
	Exg2d3->Print();
	
	std::cout<<"Endcap geometry 1.5mm max-bin:"<<std::endl;
	g2d_3->Print();

	std::cout<<"Endcap geometry 7.5mm max-bin:"<<std::endl;
	g2d3->Print();
