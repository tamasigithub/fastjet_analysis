...
{
	Exg1_ = new TGraphErrors(n,Exr2_,Exe2_,Exr_err2_,Exe_err2_);
	Exg1_->GetYaxis()->SetTitle("trigger efficiency");
	auto axis = Exg1_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exg1_->GetXaxis()->SetTitleOffset(1.2);
	Exg1_->GetXaxis()->SetTitle("trigger rate [MHz]");
	Exg1_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exg2_ = new TGraphErrors(n,Exr3_,Exe3_,Exr_err3_,Exe_err3_);
	Exg2_->GetYaxis()->SetTitle("trigger efficiency");
	axis = Exg2_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exg2_->GetXaxis()->SetTitleOffset(1.2);
	Exg2_->GetXaxis()->SetTitle("trigger rate [MHz]");
	Exg2_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exg3_ = new TGraphErrors(n,Exr4_,Exe4_,Exr_err4_,Exe_err4_);
	Exg3_->GetYaxis()->SetTitle("trigger efficiency");
	axis = Exg3_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exg3_->GetXaxis()->SetTitleOffset(1.2);
	Exg3_->GetXaxis()->SetTitle("trigger rate [MHz]");
	Exg3_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exg4_ = new TGraphErrors(n,Exr5_,Exe5_,Exr_err5_,Exe_err5_);
	Exg4_->GetYaxis()->SetTitle("trigger efficiency");
	axis = Exg4_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exg4_->GetXaxis()->SetTitleOffset(1.2);
	Exg4_->GetXaxis()->SetTitle("trigger rate [MHz]");
	Exg4_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exga1_ = new TGraphErrors(n,Exra_2,Exea_2,Exr_erra_2,Exe_erra_2);
	Exga1_->GetYaxis()->SetTitle("trigger efficiency");
	axis = Exga1_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exga1_->GetXaxis()->SetTitleOffset(1.2);
	Exga1_->GetXaxis()->SetTitle("trigger rate [MHz]");
	Exga1_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exga2_ = new TGraphErrors(n,Exra_3,Exea_3,Exr_erra_3,Exe_erra_3);
	Exga2_->GetYaxis()->SetTitle("trigger efficiency");
	axis = Exga2_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exga2_->GetXaxis()->SetTitleOffset(1.2);
	Exga2_->GetXaxis()->SetTitle("trigger rate [MHz]");
	Exga2_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exga3_ = new TGraphErrors(n,Exra_4,Exea_4,Exr_erra_4,Exe_erra_4);
	Exga3_->GetYaxis()->SetTitle("trigger efficiency");
	axis = Exga3_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exga3_->GetXaxis()->SetTitleOffset(1.2);
	Exga3_->GetXaxis()->SetTitle("trigger rate [MHz]");
	Exga3_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exga4_ = new TGraphErrors(n,Exra_5,Exea_5,Exr_erra_5,Exe_erra_5);
	Exga4_->GetYaxis()->SetTitle("trigger efficiency");
	axis = Exga4_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exga4_->GetXaxis()->SetTitleOffset(1.2);
	Exga4_->GetXaxis()->SetTitle("trigger rate [MHz]");
	Exga4_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exgb1_ = new TGraphErrors(n,Exrb_2,Exeb_2,Exr_errb_2,Exe_errb_2);
	Exgb1_->GetYaxis()->SetTitle("trigger efficiency");
	axis = Exgb1_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exgb1_->GetXaxis()->SetTitleOffset(1.2);
	Exgb1_->GetXaxis()->SetTitle("trigger rate [MHz]");
	Exgb1_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exgb2_ = new TGraphErrors(n,Exrb_3,Exeb_3,Exr_errb_3,Exe_errb_3);
	Exgb2_->GetYaxis()->SetTitle("trigger efficiency");
	axis = Exgb2_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exgb2_->GetXaxis()->SetTitleOffset(1.2);
	Exgb2_->GetXaxis()->SetTitle("trigger rate [MHz]");
	Exgb2_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exgb3_ = new TGraphErrors(n,Exrb_4,Exeb_4,Exr_errb_4,Exe_errb_4);
	Exgb3_->GetYaxis()->SetTitle("trigger efficiency");
	axis = Exgb3_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exgb3_->GetXaxis()->SetTitleOffset(1.2);
	Exgb3_->GetXaxis()->SetTitle("trigger rate [MHz]");
	Exgb3_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exgb4_ = new TGraphErrors(n,Exrb_5,Exeb_5,Exr_errb_5,Exe_errb_5);
	Exgb4_->GetYaxis()->SetTitle("trigger efficiency");
	axis = Exgb4_->GetYaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exgb4_->GetXaxis()->SetTitleOffset(1.2);
	Exgb4_->GetXaxis()->SetTitle("trigger rate [MHz]");
	Exgb4_->GetXaxis()->SetRangeUser(Ymin_range, Ymax_range);
