...
#include "summary_1.5mmTTTpp4b.cpp"
#include "summary_1.5mmTTTggF.cpp"
#include "summary_Calopp4b.cpp"
#include "summary_CaloggF.cpp"
...
///////////////////////////////////////////////////////////     
	...
	sprintf(signal_file_name_2, "%s/CELL_a50c3_ALL_PU%spp_4bQCD_ETA2.5_30mm_R0.4_2.root",file_path_2,pileup);//,gapsize);//7.5
	...
	sprintf(MinBias_file_name_2, "%s/CELL_a50c3_ALL_PU%sMB_pp4b_ETA2.5_30mm_R0.4_2.root",file_path_2,pileup);//,gapsize);//7.5
	...
	sprintf(signal_file_name_3, "%s/CELL_a50c3_ALL_PU%sggF_ETA2.5_30mm_R0.4_2.root",file_path_2,pileup);//,gapsize);//1.5
	std::cout<<"signal file name: " <<signal_file_name <<std::endl;
	...
	sprintf(MinBias_file_name_3, "%s/CELL_a50c3_ALL_PU%sMB_ETA2.5_30mm_R0.4_2.root",file_path_2,pileup);//,gapsize);//1.5
...
///////////////////////////////////////////////////////////////////////
	...
	J1->SetFillColor(kWhite);
        ...
        J1->SetTextSize(0.04);
	J1->Draw();
	TLegend *l1___ = new TLegend(x1+0.12, y1, x2, y2, "");
	l1___->SetBorderSize(0);
	l1___->SetFillColor(kWhite);
	l1___->SetTextSize(0.04);
	l1___->AddEntry(ga2d_1,"#kern[-3.0]{ } ggF TTT-jet","p");// multi-bin: #pm 1.5mm","p");
	l1___->AddEntry(ga2d1,"#kern[-3.0]{ } pp4b TTT-jet","p");// multi-bin: #pm 1.5 mm", "p");
	l1___->AddEntry(Exga2d_1,"#kern[-3.0]{ } ggF calo-jet","p");
	l1___->AddEntry(Exga2d1,"#kern[-3.0]{ } pp4b calo-jet", "p");
	...
	leg1->Draw();
	leg5->Draw();
	TLegend *l_1___ = new TLegend(x1+0.12, y1, x2, y2, "");
	l_1___->SetBorderSize(0);
	l_1___->SetFillColor(kWhite);
	l_1___->SetTextSize(0.04);
	l_1___->AddEntry(g2d_1,"#kern[-3.0]{ } ggF TTT-jet, max-bin","p");//: #pm 1.5mm","p");
	l_1___->AddEntry(g2d1,"#kern[-3.0]{ } pp4b TTT-jet, max-bin","p");//: #pm 7.5 mm", "p");
	l_1___->AddEntry(Exg2d_1,"#kern[-3.0]{ } ggF calo-jet","p");
	l_1___->AddEntry(Exg2d1,"#kern[-3.0]{ } pp4b calo-jet", "p");
