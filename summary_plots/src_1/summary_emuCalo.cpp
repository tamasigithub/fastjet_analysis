...
{
	//gb_1_ = new TGraphErrors(n,eb__2,rb__2,0,0);
	gb_1_ = new TGraphErrors(n,eb__2,rb__2,e_errb__2,r_errb__2);
	gb_1_->GetXaxis()->SetTitle("trigger efficiency");
	auto axis = gb_1_->GetXaxis();
	...
	//gb_2_ = new TGraphErrors(n,eb__3,rb__3,0,0);
	gb_2_ = new TGraphErrors(n,eb__3,rb__3,e_errb__3,r_errb__3);
	...
	//gb_3_ = new TGraphErrors(n,eb__4,rb__4,0,0);
	gb_3_ = new TGraphErrors(n,eb__4,rb__4,e_errb__4,r_errb__4);
	...
	//gb_4_ = new TGraphErrors(n,eb__5,rb__5,0,0);
	gb_4_ = new TGraphErrors(n,eb__5,rb__5,e_errb__5,r_errb__5);
