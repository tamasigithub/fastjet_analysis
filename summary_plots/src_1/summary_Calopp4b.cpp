...
void fetch_7_5mmExTTT()
{
	...
	//! sumpt approach
	ExE2 = (TH1F*)Exf->Get("hb_tJeff2");//("h_tJeff2");
	ExE3 = (TH1F*)Exf->Get("hb_tJeff3");//("h_tJeff3");
	ExE4 = (TH1F*)Exf->Get("hb_tJeff4");//("h_tJeff4");
	ExE5 = (TH1F*)Exf->Get("hb_tJeff5");//("h_tJeff5");
	//! Lpt bins approach
	ExEa2 = (TH1F*)Exf->Get("hb_tJeff2");//("ha_tJeff2");
	ExEa3 = (TH1F*)Exf->Get("hb_tJeff3");//("ha_tJeff3");
	ExEa4 = (TH1F*)Exf->Get("hb_tJeff4");//("ha_tJeff4");
	ExEa5 = (TH1F*)Exf->Get("hb_tJeff5");//("ha_tJeff5");
	//! no z-vertex bin 
	...
	//! sumpt approach
	ExR2 = (TH1F*)Exf1->Get("hb_PUNLpt");   //("h_PUNLpt");
	ExR3 = (TH1F*)Exf1->Get("hb_PUNNLpt");  //("h_PUNNLpt");
	ExR4 = (TH1F*)Exf1->Get("hb_PUNNNLpt"); //("h_PUNNNLpt");
	ExR5 = (TH1F*)Exf1->Get("hb_PUNNNNLpt");//("h_PUNNNNLpt");
	//! Lpt bins approach
	ExRa2 = (TH1F*)Exf1->Get("hb_PUNLpt");   //("ha_PUNLpt");
	ExRa3 = (TH1F*)Exf1->Get("hb_PUNNLpt");  //("ha_PUNNLpt");
	ExRa4 = (TH1F*)Exf1->Get("hb_PUNNNLpt"); //("ha_PUNNNLpt");
	ExRa5 = (TH1F*)Exf1->Get("hb_PUNNNNLpt");//("ha_PUNNNNLpt");
	//! no z-vertex bin 
...
void make_graphs_7_5mmExTTT()
{
	...
	Exg1 = new TGraphErrors(n,Exe2,Exr2,Exe_err2,Exr_err2);
	Exg1->GetXaxis()->SetTitle("trigger efficiency");
	auto axis = Exg1->GetXaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exg1->GetYaxis()->SetTitleOffset(1.2);
	Exg1->GetYaxis()->SetTitle("trigger rate [MHz]");
	Exg1->GetYaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exg2 = new TGraphErrors(n,Exe3,Exr3,Exe_err3,Exr_err3);
	Exg2->GetXaxis()->SetTitle("trigger efficiency");
	axis = Exg2->GetXaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exg2->GetYaxis()->SetTitleOffset(1.2);
	Exg2->GetYaxis()->SetTitle("trigger rate [MHz]");
	Exg2->GetYaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exg3 = new TGraphErrors(n,Exe4,Exr4,Exe_err4,Exr_err4);
	Exg3->GetXaxis()->SetTitle("trigger efficiency");
	axis = Exg3->GetXaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exg3->GetYaxis()->SetTitleOffset(1.2);
	Exg3->GetYaxis()->SetTitle("trigger rate [MHz]");
	Exg3->GetYaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exg4 = new TGraphErrors(n,Exe5,Exr5,Exe_err5,Exr_err5);
	Exg4->GetXaxis()->SetTitle("trigger efficiency");
	axis = Exg4->GetXaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exg4->GetYaxis()->SetTitleOffset(1.2);
	Exg4->GetYaxis()->SetTitle("trigger rate [MHz]");
	Exg4->GetYaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exga1 = new TGraphErrors(n,Exea2,Exra2,Exe_erra2,Exr_erra2);
	Exga1->GetXaxis()->SetTitle("trigger efficiency");
	axis = Exga1->GetXaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exga1->GetYaxis()->SetTitleOffset(1.2);
	Exga1->GetYaxis()->SetTitle("trigger rate [MHz]");
	Exga1->GetYaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exga2 = new TGraphErrors(n,Exea3,Exra3,Exe_erra3,Exr_erra3);
	Exga2->GetXaxis()->SetTitle("trigger efficiency");
	axis = Exga2->GetXaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exga2->GetYaxis()->SetTitleOffset(1.2);
	Exga2->GetYaxis()->SetTitle("trigger rate [MHz]");
	Exga2->GetYaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exga3 = new TGraphErrors(n,Exea4,Exra4,Exe_erra4,Exr_erra4);
	Exga3->GetXaxis()->SetTitle("trigger efficiency");
	axis = Exga3->GetXaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exga3->GetYaxis()->SetTitleOffset(1.2);
	Exga3->GetYaxis()->SetTitle("trigger rate [MHz]");
	Exga3->GetYaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exga4 = new TGraphErrors(n,Exea5,Exra5,Exe_erra5,Exr_erra5);
	Exga4->GetXaxis()->SetTitle("trigger efficiency");
	axis = Exga4->GetXaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exga4->GetYaxis()->SetTitleOffset(1.2);
	Exga4->GetYaxis()->SetTitle("trigger rate [MHz]");
	Exga4->GetYaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exgb1 = new TGraphErrors(n,Exeb2,Exrb2,Exe_errb2,Exr_errb2);
	Exgb1->Draw("AP");
	axis = Exgb1->GetXaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exgb1->GetYaxis()->SetTitleOffset(1.2);
	Exgb1->GetYaxis()->SetTitle("trigger rate [MHz]");
	Exgb1->GetXaxis()->SetTitle("trigger efficiency");
	Exgb1->GetYaxis()->CenterTitle();
	Exgb1->GetXaxis()->CenterTitle();
	Exgb1->GetYaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exgb2 = new TGraphErrors(n,Exeb3,Exrb3,Exe_errb3,Exr_errb3);
	Exgb2->Draw("AP");
	Exgb2->GetXaxis()->SetTitle("trigger efficiency");
	axis = Exgb2->GetXaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exgb2->GetYaxis()->SetTitleOffset(1.2);
	Exgb2->GetYaxis()->SetTitle("trigger rate [MHz]");
	Exgb2->GetYaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exgb3 = new TGraphErrors(n,Exeb4,Exrb4,Exe_errb4,Exr_errb4);
	Exgb3->Draw("AP");
	Exgb3->GetXaxis()->SetTitle("trigger efficiency");
	axis = Exgb3->GetXaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exgb3->GetYaxis()->SetTitleOffset(1.2);
	Exgb3->GetYaxis()->SetTitle("trigger rate [MHz]");
	Exgb3->GetYaxis()->SetRangeUser(Ymin_range, Ymax_range);
	...
	Exgb4 = new TGraphErrors(n,Exeb5,Exrb5,Exe_errb5,Exr_errb5);
	Exgb4->Draw("AP");
	Exgb4->GetXaxis()->SetTitle("trigger efficiency");
	axis = Exgb4->GetXaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	Exgb4->GetYaxis()->SetTitleOffset(1.2);
	Exgb4->GetYaxis()->SetTitle("trigger rate [MHz]");
	Exgb4->GetYaxis()->SetRangeUser(Ymin_range, Ymax_range);
