...
void make_graphs_7_5mmTTT()
{
	...
	g1 = new TGraphErrors(n,e2,r2,e_err2,r_err2);
	...
	g2 = new TGraphErrors(n,e3,r3,e_err3,r_err3);
	...
	g3 = new TGraphErrors(n,e4,r4,e_err4,r_err4);
	...
	g4 = new TGraphErrors(n,e5,r5,e_err5,r_err5);
	...
	ga1 = new TGraphErrors(n,ea2,ra2,e_erra2,r_erra2);
	...
	ga2 = new TGraphErrors(n,ea3,ra3,e_erra3,r_erra3);
	...
	ga3 = new TGraphErrors(n,ea4,ra4,e_erra4,r_erra4);
	...
	ga4 = new TGraphErrors(n,ea5,ra5,e_erra5,r_erra5);
	...
	gb1 = new TGraphErrors(n,eb2,rb2,e_errb2,r_errb2);
	gb1->Draw("AP");
	axis = gb1->GetXaxis();
	axis->SetLimits(Xmin_range, Xmax_range);
	...
	gb2 = new TGraphErrors(n,eb3,rb3,e_errb3,r_errb3);
	gb2->Draw("AP");
	...
	gb3 = new TGraphErrors(n,eb4,rb4,e_errb4,r_errb4);
	gb3->Draw("AP");
	...
	gb4 = new TGraphErrors(n,eb5,rb5,e_errb5,r_errb5);
	gb4->Draw("AP");
