...
void Gen_output::Branch_OutTree()
{
	...
	glob_jet->Branch("v_bPt",&v_bPt);
	glob_jet->Branch("v_bEta",&v_bEta);
	glob_jet->Branch("v_bPhi",&v_bPhi);
	glob_jet->Branch("v_bM",&v_bM);
	glob_jet->Branch("NSMhiggs",&NSMhiggs);
	glob_jet->Branch("v_higgsPt",&v_higgsPt);
	glob_jet->Branch("v_higgsEta",&v_higgsEta);
	glob_jet->Branch("v_higgsPhi",&v_higgsPhi);
	glob_jet->Branch("v_higgsM",&v_higgsM);
