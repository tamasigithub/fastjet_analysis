...
#include "TH1D.h"
#include "TLatex.h"
const char *out_path = "./summary_plots/tex";
const char *in_path = "./summary_plots/pdf";
...
void pad(const char *pad_name, int which_legend = 0, bool up = false, bool left = false, const char *input_file = "TrigSummary3trk_7.5_1.5_5GeV_Caloq1.2GeV_5GeV25mm_1.root");
{
