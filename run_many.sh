#!/bin/sh
sed -i -e 's/Genjet_ggF_Ctr-2.0_q1.2GeV_2.5.root/Genjet_ggF_Ctr1.0_q1.2GeV_2.5_5NoSmear.root/g' ./Gen_Jet_1.cc
...
sed -i -e 's/Genjet_ggF_Ctr1.0_q1.2GeV_2.5_5NoSmear.root/Genjet_ggF_Ctr2.0_q1.2GeV_2.5_5NoSmear.root/g' ./Gen_Jet_1.cc
...
sed -i -e 's/Genjet_ggF_Ctr2.0_q1.2GeV_2.5_5NoSmear.root/Genjet_ggF_Ctr2.5_q1.2GeV_2.5_5NoSmear.root/g' ./Gen_Jet_1.cc
...
sed -i -e 's/Genjet_ggF_Ctr2.5_q1.2GeV_2.5_5NoSmear.root/Genjet_ggF_Ctr3.0_q1.2GeV_2.5_5NoSmear.root/g' ./Gen_Jet_1.cc
...
sed -i -e 's/Genjet_ggF_Ctr3.0_q1.2GeV_2.5_5NoSmear.root/Genjet_ggF_Ctr5.0_q1.2GeV_2.5_5NoSmear.root/g' ./Gen_Jet_1.cc
...
sed -i -e 's/Genjet_ggF_Ctr5.0_q1.2GeV_2.5_5NoSmear.root/Genjet_ggF_Ctr0.0_q1.2GeV_2.5_5NoSmear.root/g' ./Gen_Jet_1.cc
...
sed -i -e 's/Genjet_ggF_Ctr0.0_q1.2GeV_2.5_5NoSmear.root/Genjet_ggF_Ctr-1.0_q1.2GeV_2.5_5NoSmear.root/g' ./Gen_Jet_1.cc
...
sed -i -e 's/Genjet_ggF_Ctr-1.0_q1.2GeV_2.5_5NoSmear.root/Genjet_ggF_Ctr-2.0_q1.2GeV_2.5_5NoSmear.root/g' ./Gen_Jet_1.cc
