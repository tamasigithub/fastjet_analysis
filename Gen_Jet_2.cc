...
//****************object and file creation and  reading of input files***************//
  ...
  //TFile *f_out = new TFile("./fastjet_output/Genjet2_pp4b_q300MeV_2.5_allR0.4.root","RECREATE");
  //TFile *f_out = new TFile("./fastjet_output/Genjet2_ggF_Ctr-2.0_q300MeV_2.5_allR0.4.root","RECREATE");
  ...
  //rec.Add("/eos/user/t/tkar/grid_files/user.tkar.pp_4bQCD_pythia82_GenCuts.v4_output.root/*.root");
  rec.Add("/eos/user/t/tkar/grid_files/user.tkar.pp_ggF_Ctr2.5hh_pythia82_GenCuts.v4_output.root/*.root");
