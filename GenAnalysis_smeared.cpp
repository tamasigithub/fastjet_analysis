...
void plot()
{
	...
	Ana_bjetLPt_2->GetYaxis()->SetRangeUser(1e2, max_rangeM);
	Ana_bjetLPt_2->Draw();
	...
	Ana_bjetLPtB->GetYaxis()->SetRangeUser(1e2, max_rangeM);
	Ana_bjetLPtB->Draw();
...
//	C->Clear();
	...
	Ana_bjet2LPt_2->GetYaxis()->SetRangeUser(1e2, max_rangeM);
	Ana_bjet2LPt_2->Draw();
	...
	Ana_bjet2LPtB->GetYaxis()->SetRangeUser(1e2, max_rangeM);
	Ana_bjet2LPtB->Draw();
	...
	Ana_bjet3LPt_2->GetYaxis()->SetRangeUser(1e2, max_rangeM);
	Ana_bjet3LPt_2->Draw();
	...
	Ana_bjet3LPtB->GetYaxis()->SetRangeUser(1e2, max_rangeM);
	Ana_bjet3LPtB->Draw();
	...
	C->cd(1);
	gPad->SetLogy(); gPad->SetLogx();
	Ana_bjet4LPt_2->SetTitle("after Ana cuts, normalized to 30ab^{-1}");
	max_rangeM = Ana_bjet4LPt_2->GetMaximum() * 1.3;
	Ana_bjet4LPt_2->GetYaxis()->SetRangeUser(1e2, max_rangeM);
	Ana_bjet4LPt_2->Draw();
	...
	Ana_bjet4LPtB->GetYaxis()->SetRangeUser(1e2, max_rangeM);
	Ana_bjet4LPtB->Draw();
