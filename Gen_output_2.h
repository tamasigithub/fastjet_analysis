...
public:
	...
	std::vector<double> jetM;				//  truth-jet transverse mass square = (E + pz)(E- pz)
	...
	std::vector<double> v_bPhi;
	std::vector<double> v_bM;
	std::vector<double> v_higgsPt;
	std::vector<double> v_higgsEta;
	std::vector<double> v_higgsPhi;
	std::vector<double> v_higgsM;
